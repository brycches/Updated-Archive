...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for line in symbol_quantity_list:
        ...
        total_atomic_mass += quantity * atomic_mass
...
def get_formula_name(formula, known_molecules_dict):
    ...
    Parameters:
        ...
        known_molecules_dict (dict): A dictionary that contains known chemical formulas and their names.

    Returns:
        str: The name of a chemical formula if found in the dictionary, or "unknown compound".
    """
